...
% Extract and define all the calculated unknown parameters for each step
    ...
    Vel_D     = (-dz)*(Viscous)*(d(:, 2*N+6:3*N+6)-d(:, 2*N+5:3*N+5))  ;
...
steps = {
    ...
    'Vapor Stripping', t4, qCO2_D, qH2O_D, yCO2_D, yH2O_D, Temp_D, Press_D, PCO2_D, PH2O_D,Vel_D;
    'Final Desorption', t5, qCO2_E, qH2O_E, yCO2_E, yH2O_E, Temp_E, Press_E, PCO2_E, PH2O_E, Vel_E;
};
