...
% Isotherms for Moisture Swing Material, IRA900
...
% k_ap     : is the equilibrium constant [mol/kg*Pa]
% c_ap     : is the concentration of water [mmol/g]
% x     : is the partial pressure of CO2 [Pa]
% n     : is an exponential function fitted from experimental data [-] 
% Emo   : is the monolayer heats of sorption [kJ/mol].
% Eml   : is the heats of sorption of the multi-layer [kJ/mol]
...
% Calculate the water isotherm 
    ...
    Ec      = -44.38.*T + 57220         ;       % Heats of adsorption for 10th+ layer [J/mol]
