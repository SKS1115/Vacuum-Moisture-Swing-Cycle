...
function MassBalance = MassBalanceFxn(a,b,c,e,f,t1,t2,t3,t4,t5, N, L, ColumnParam, CondParam)
    ...
    [Uin_vp , Uout_vp , JMB_vp_CO2 , molCO2in_vp , molCO2out_vp , netCO2_vp , netCO2_SP_vp , netCO2_GP_vp , molCO2_SB_vp , ~ , nCO2out_vp ]     = CO2_balance(Press_E, Temp_E, yCO2_E, yH2O_E, qCO2_E, qH2O_E, t4);
    [Uin_des, Uout_des, JMB_des_CO2, molCO2in_des, molCO2out_des, netCO2_des, netCO2_SP_des, netCO2_GP_des, molCO2_SB_des, ~, nCO2out_des ]     = CO2_balance(Press_F, Temp_F, yCO2_F, yH2O_F, qCO2_F, qH2O_F, t5);
...
% Compute Mass Balance for Each Step
    ...
    [JMB_vp_H2O , molH2Oin_vp , molH2Oout_vp , netH2O_vp , netH2O_SP_vp , netH2O_GP_vp , molH2O_SB_vp , nH2Oin_vp, nH2Oout_vp]     = H2O_balance(Press_E, Temp_E, yCO2_E, yH2O_E, qCO2_E, qH2O_E, t4);
    [JMB_des_H2O, molH2Oin_des, molH2Oout_des, netH2O_des, netH2O_SP_des, netH2O_GP_des, molH2O_SB_des, ~, nH2Oout_des       ]     = H2O_balance(Press_F, Temp_F, yCO2_F, yH2O_F, qCO2_F, qH2O_F, t5);
...
% Compute Mass Balance for Each Step
    ...
    [~ , molN2out_vp , ~, nN2out_vp]     = N2_balance(Press_E, Temp_E, yCO2_E, yH2O_E, qCO2_E, qH2O_E, yN2_E, t4);
    [~, molN2out_des, ~, nN2out_des]     = N2_balance(Press_F, Temp_F, yCO2_F, yH2O_F, qCO2_F, qH2O_F, yN2_F, t5);
