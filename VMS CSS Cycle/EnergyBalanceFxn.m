function EnergyBalance = EnergyBalanceFxn(a,b,c,e,f,t1,t2,t3,t4,t5,N,L,ColumnParam,CondParam,isotherm_parameters) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                Energy Balance
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
...
% Retrieve Necessary parameters and calculate constants
 ...
 % Extract Data Function
    ...
    [Heat_in_vs, Heat_out_vs, Heat_gen_vs, Heat_SP_vs, Heat_GP_vs, Heat_SB_vs, JEB_vs]    =StepEnergyBalance(Press_E, Temp_E, yCO2_E, yH2O_E, qCO2_E, qH2O_E, t4);
    [Heat_in_ds, Heat_out_ds, Heat_gen_ds, Heat_SP_ds, Heat_GP_ds, Heat_SB_ds, JEB_ds]    =StepEnergyBalance(Press_F, Temp_F, yCO2_F, yH2O_F, qCO2_F, qH2O_F, t5);
